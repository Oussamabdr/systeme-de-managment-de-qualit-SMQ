...
const getNavItems = (language) => [
  {
    ...
    roles: ["ADMIN", "PROJECT_MANAGER", "TEAM_MEMBER", "CAQ", "AUDITEUR_EXTERNE"],
    group: "pilotage",
  },
  {
    to: "/projects",
    ...
    icon: FolderKanban,
    roles: ["ADMIN", "PROJECT_MANAGER", "AUDITEUR_EXTERNE"],
    group: "pilotage",
  },
  {
    to: "/processes",
  ...
  },
  {
    ...
    icon: ListTodo,
    roles: ["ADMIN", "PROJECT_MANAGER", "TEAM_MEMBER", "AUDITEUR_EXTERNE"],
    group: "execution",
  },
  {
    to: "/documents",
  ...
  },
  {
    ...
    icon: ShieldAlert,
    roles: ["ADMIN", "PROJECT_MANAGER", "CAQ", "AUDITEUR_EXTERNE"],
    group: "assurance",
  },
  {
